...
const ThreadCard = ({id,parentId, content, currentUserId, author, community,createdAt, comments, isComment }: Props) => {
  return (
            ...
            <div className='flex w-full flex-col'>
                ...
                <div className={` ${isComment && 'mb-10'} mt-5 flex flex-col gap-3`} >
                    <div className='flex gap-3.5'>
                        ...
                        <Link href={`/thread/${id}`}>
                        <Image src="/assets/reply.svg" alt="reply" width={24} height={24} className='cursor-pointer object-contain'></Image></Link>
